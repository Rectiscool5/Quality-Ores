...
public class SaphirePickaxeItem extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:saphire_pickaxe")
	public static final Item block = null;
	public SaphirePickaxeItem(QualityOresModElements instance) {
		super(instance, 70);
	}
