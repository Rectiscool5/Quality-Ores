...
public class SaphireHoeItem extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:saphire_hoe")
	public static final Item block = null;
	public SaphireHoeItem(QualityOresModElements instance) {
		super(instance, 74);
	}
