...
public class SaphireSwordItem extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:saphire_sword")
	public static final Item block = null;
	public SaphireSwordItem(QualityOresModElements instance) {
		super(instance, 72);
	}
