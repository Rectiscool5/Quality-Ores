...
public class ObstridianAxeItem extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:obstridian_axe")
	public static final Item block = null;
	public ObstridianAxeItem(QualityOresModElements instance) {
		super(instance, 29);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("obstridian_axe"));
	}
}
