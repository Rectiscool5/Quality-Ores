...
import net.mcreator.qualityores.item.ObstridianIngotItem;
...
public class ObstridianOreBlock extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:obstridian_ore")
	public static final Block block = null;
	public ObstridianOreBlock(QualityOresModElements instance) {
		super(instance, 23);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("obstridian_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ObstridianIngotItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("quality_ores:obstridian_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("obstridian_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("quality_ores:obstridian_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
