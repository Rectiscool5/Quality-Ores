...
public class RubyBlockBlock extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(QualityOresModElements instance) {
		super(instance, 45);
	}
