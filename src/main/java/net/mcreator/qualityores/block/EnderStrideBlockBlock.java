...
public class EnderStrideBlockBlock extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:ender_stride_block")
	public static final Block block = null;
	public EnderStrideBlockBlock(QualityOresModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ender_stride_block");
		}
