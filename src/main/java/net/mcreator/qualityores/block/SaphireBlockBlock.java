...
public class SaphireBlockBlock extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:saphire_block")
	public static final Block block = null;
	public SaphireBlockBlock(QualityOresModElements instance) {
		super(instance, 66);
	}
