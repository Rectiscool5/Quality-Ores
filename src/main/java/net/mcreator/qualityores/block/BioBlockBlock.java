...
public class BioBlockBlock extends QualityOresModElements.ModElement {
	@ObjectHolder("quality_ores:bio_block")
	public static final Block block = null;
	public BioBlockBlock(QualityOresModElements instance) {
		super(instance, 87);
	}
